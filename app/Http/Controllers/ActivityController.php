...
class ActivityController extends Controller
{
  public function index()
  {
      $activities = Activity::query()
          ->select('id', 'time', 'description', 'pendencies', 'status', 'receptivity_id', 'activity_type_id', 'contact_id',)
  ...
  public function store()
  {
      ...
      $activities = Activity::create($validateData);
  ...
  {
      $activity->load(['cityHall'=> fn ($query) =>$query
  ...
  public function edit(Activity $activity)
  {
      $contacts = Contact::orderBy('name')->get(['id', 'name']);
      $activityTypes = ActivityType::orderBy('name')->get(['id', 'name']);
      $receptivities = Receptivity::orderBy('name')->get(['id', 'name','phone']);

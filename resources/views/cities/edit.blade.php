                          ...
                          <div class="col-span-3">
                            ...
                            <div class="col-span-3">
                                <label for="state" class="block text-lg font-medium leading-5 text-gray-700">
                                    {{ __('Estado:') }}
                                    <input id="state" type="text" class="mt-1 form-input block w-full py-2 px-3 border border-gray-300 rounded-md shadow-sm focus:outline-yellow focus:shadow-outline-yellow focus:border-yellow-300 transition duration-150 ease-in-out sm:text-lg sm:leading-5" name="state" value="{{ $city->state }}" required autofocus>
                            </div>
                      </div>
                      <div class="mt-6">
